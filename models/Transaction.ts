...
export interface ITransaction extends Document {
  ...
  type: 'DEPOSIT' | 'WITHDRAWAL' | 'ENTRY_FEE' | 'PAYOUT' | 'BONUS' | 'FREE_HIT_FEE' | 'CONTEST_PAYOUT';
  amount: number;
...
const TransactionSchema: Schema = new Schema(
  {
    ...
    type: { type: String, enum: ['DEPOSIT', 'WITHDRAWAL', 'ENTRY_FEE', 'PAYOUT', 'BONUS', 'FREE_HIT_FEE', 'CONTEST_PAYOUT'], required: true },
