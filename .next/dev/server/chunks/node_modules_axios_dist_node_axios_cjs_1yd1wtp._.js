...
/*! Axios v1.19.0 Copyright (c) 2026 Matt Zabriskie and contributors */ var FormData$1 = __turbopack_context__.r("[project]/node_modules/form-data/lib/form_data.js [app-route] (ecmascript)");
var crypto = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)");
var url = __turbopack_context__.r("[externals]/url [external] (url, cjs)");
var HttpsProxyAgent = __turbopack_context__.r("[project]/node_modules/https-proxy-agent/dist/index.js [app-route] (ecmascript)");
var http = __turbopack_context__.r("[externals]/http [external] (http, cjs)");
var https = __turbopack_context__.r("[externals]/https [external] (https, cjs)");
var http2 = __turbopack_context__.r("[externals]/http2 [external] (http2, cjs)");
var util = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
var path = __turbopack_context__.r("[externals]/path [external] (path, cjs)");
var followRedirects = __turbopack_context__.r("[project]/node_modules/follow-redirects/index.js [app-route] (ecmascript)");
...
class AxiosHeaders {
    ...
    getSetCookie() {
        ...
        return utils$1.isArray(value) ? value : value == null || value === false ? [] : [
            value
        ];
    }
    ...
    function buildPath(path, value, target, index) {
        ...
        if (isLast) {
            if (utils$1.hasOwnProp(target, name)) {
                target[name] = utils$1.isArray(target[name]) ? target[name].concat(value) : [
                    target[name],
                    value
                ];
            } else {
...
/*eslint consistent-return:0*/ var httpAdapter = isHttpAdapterSupported && function httpAdapter(config) {
    return wrapAsync(async function dispatchHttpRequest(resolve, reject, onDone) {
        ...
        if (lookup) {
            const _lookup = callbackify(lookup, (value)=>utils$1.isArray(value) ? value : [
                    value
                ]);
...
const factory = (env)=>{
    ...
    const { ReadableStream: ReadableStream1, TextEncoder: TextEncoder1 } = globalObject;
    ...
    const isReadableStreamSupported = isFetchSupported && isFunction(ReadableStream1);
    const encodeText = isFetchSupported && (typeof TextEncoder1 === 'function' ? ((encoder)=>(str)=>encoder.encode(str))(new TextEncoder1()) : async (str)=>new Uint8Array(await new Request(str).arrayBuffer()));
            ...
            if (hasMaxContentLength && !supportsResponseStream && !isStreamResponse) {
                ...
                if (responseData != null) {
                    if (typeof responseData.byteLength === 'number') {
                        ...
                        materializedSize = typeof TextEncoder1 === 'function' ? new TextEncoder1().encode(responseData).byteLength : responseData.length;
                    }
                }
...
//# sourceMappingURL=node_modules_axios_dist_node_axios_cjs_1yd1wtp._.js.map