...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Transaction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Transaction.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        // Fetch transactions
        const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Transaction$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mappedTransactions);
    } catch (error) {
...
function getTransactionDescription(type, refId) {
    switch(type){
        case 'DEPOSIT':
...
"[project]/models/Transaction.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dmch-b._.js.map