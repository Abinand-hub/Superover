...
export const INITIAL_MATCHES: CricketMatch[] = [
  ...
  {
    id: 'match_ind_aus_t20',
    title: 'India vs Australia',
    series: 'ICC T20 Championship Series',
  ...
  },
  {
    ...
    actualResults: {
      top_batter: { playerId: 'p_samson', statValue: '86* (46 balls)', playerName: 'Sanju Samson' },
      top_bowler: { playerId: 'p_rashid', statValue: '3/18 (4.0 ov)', playerName: 'Rashid Khan' },
      top_striker: { playerId: 'p_miller', statValue: '244.4 SR (44 off 18)', playerName: 'David Miller' },
      best_economy: { playerId: 'p_boult', statValue: '5.50 Econ (2/22 in 4.0)', playerName: 'Trent Boult' },
      most_sixes: { playerId: 'p_samson', statValue: '6 Sixes', playerName: 'Sanju Samson' },
      most_wickets: { playerId: 'p_rashid', statValue: '3 Wickets', playerName: 'Rashid Khan' },
...
export const INITIAL_SLIPS: UserPredictionSlip[] = [
  {
    ...
    entryFee: 50,
    answers: {
      top_batter: 'p_samson', // Correct!
      top_bowler: 'p_rashid', // Correct!
      top_striker: 'p_miller', // Correct!
      best_economy: 'p_rashid', // Boult was 5.50 (Wrong)
      most_sixes: 'p_samson', // Correct!
      most_wickets: 'p_rashid', // Correct!
    },
    ...
    settlementDetails: [
      {
        questionKey: 'top_batter',
        questionTitle: 'Top Batter',
        userPickPlayerId: 'p_samson',
        userPickPlayerName: 'Sanju Samson',
        userPickTeam: 'RR',
        actualWinnerPlayerId: 'p_samson',
        actualWinnerPlayerName: 'Sanju Samson',
        actualWinnerTeam: 'RR',
        actualStatValue: '86* (46 balls)',
        isCorrect: true,
      },
      {
        questionKey: 'top_bowler',
        questionTitle: 'Top Bowler',
        userPickPlayerId: 'p_rashid',
        userPickPlayerName: 'Rashid Khan',
        userPickTeam: 'GT',
        actualWinnerPlayerId: 'p_rashid',
        actualWinnerPlayerName: 'Rashid Khan',
        actualWinnerTeam: 'GT',
        actualStatValue: '3/18 (4.0 ov)',
        isCorrect: true,
      },
      {
        questionKey: 'top_striker',
        questionTitle: 'Top Striker',
        userPickPlayerId: 'p_miller',
        userPickPlayerName: 'David Miller',
        userPickTeam: 'GT',
        actualWinnerPlayerId: 'p_miller',
        actualWinnerPlayerName: 'David Miller',
        actualWinnerTeam: 'GT',
        actualStatValue: '244.4 SR (44 off 18)',
        isCorrect: true,
      },
      {
        questionKey: 'best_economy',
        questionTitle: 'Most Economical Bowler',
        userPickPlayerId: 'p_rashid',
        userPickPlayerName: 'Rashid Khan',
        userPickTeam: 'GT',
        actualWinnerPlayerId: 'p_boult',
        actualWinnerPlayerName: 'Trent Boult',
        actualWinnerTeam: 'RR',
        actualStatValue: '5.50 Econ (2/22 in 4.0)',
        isCorrect: false,
      },
      {
        questionKey: 'most_sixes',
        questionTitle: 'Most 6s',
        userPickPlayerId: 'p_samson',
        userPickPlayerName: 'Sanju Samson',
        userPickTeam: 'RR',
        actualWinnerPlayerId: 'p_samson',
        actualWinnerPlayerName: 'Sanju Samson',
        actualWinnerTeam: 'RR',
        actualStatValue: '6 Sixes',
        isCorrect: true,
      },
      {
        questionKey: 'most_wickets',
        questionTitle: 'Most Wickets',
        userPickPlayerId: 'p_rashid',
        userPickPlayerName: 'Rashid Khan',
        userPickTeam: 'GT',
        actualWinnerPlayerId: 'p_rashid',
